...
\chapter{Análisis de Ciclo de Vida de un adoquín}
...
El adoquín a estudio es el modelo Holanda 6, de dimensiones 200x100x60 \si{mm}.

Los límites del sistema (ver figura XXX)

FIGURA XXX Diagrama de flujo

Los límites no incluirán el molde, palé, gastos de gestión y mantenimiento de oficinas.
...
\section{Unidad funcional}

\section{Inventario del Ciclo de Vida (ICV)}\label{cap:fabricacion}
